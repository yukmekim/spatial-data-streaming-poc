...
import dev.yukmekim.spatialdatastreamingpoc.scan.service.ScanQueueService;
...
public class ScanController {
    ...
    public ResponseEntity<Response<String>> receiveScanDataAsync(
            ...
            @Valid @RequestBody List<AppleItemRequestDto> appleItems) {

        scanQueueService.enqueue(versionCode, appleItems);
